...
Если `secret` пустой — авторизация не требуется, но для продакшена рекомендуется использовать секрет.

---

**Вопросы и поддержка:** Создайте issue в репозитории проекта
